  ...
  if (age === 0) {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 206 261.5">
        <g>
          <g>
            <path fill={color} d="M77,110.44c39.77-16.55,81.68,11.13,93.18,31.42,9.51,16.77,26.27,77.38-23,106.2-38.62,22.58-84.9,12.7-108.42-15.42C13.22,202.11,10.87,138,77,110.44Z"/>
            <path style={{
              fill: "none",
              stroke: '#212121',
              strokeLinecap: 'round',
